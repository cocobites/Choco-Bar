package com.cocobites.chocobar
 ...
 * @date:           2019/3/15
 */
class ChocoBar : LifecycleObserver {
    ...
    companion object {
        ...
        private val puddingMapX: MutableMap<String, ChocoBar> = mutableMapOf()

        @JvmStatic
        fun create(activity: AppCompatActivity, block: Choco.() -> Unit): ChocoBar {
            val pudding = ChocoBar()
